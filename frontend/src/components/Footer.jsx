    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-semibold mb-4">NSS RVCE Event Tracker</h3>
            <p className="text-gray-400">Empowering students to track their social service journey and grow through active participation.</p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/dashboard" className="text-gray-400 hover:text-white transition duration-300">Dashboard</Link></li>
              <li><Link to="/about" className="text-gray-400 hover:text-white transition duration-300">About NSS</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="mailto:nss@rvce.edu.in" className="text-gray-400 hover:text-white transition duration-300">
              </a>
            </div>
          </div>
        </div>
        <div className="mt-8 pt-8 border-t border-gray-700 text-center">
          <p className="text-gray-400">&copy; {new Date().getFullYear()} NSS RVCE Event Tracker. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
