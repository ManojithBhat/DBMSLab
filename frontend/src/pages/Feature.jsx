...
const features = [
  ...
  },
  {
    ...
    description: "Get an overview of your activities and important information.",
    icon: "📊",
    route: "/profile",
  },
  {
  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-8">
        <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">Project Features</h2>
        <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
          Our project offers a comprehensive platform for managing events, connecting with points of contact, and
          facilitating community engagement. Whether you're a student, admin, or counsellor, our features are designed
          to streamline your experience and enhance collaboration within the organization.
        </p>
