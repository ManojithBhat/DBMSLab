...
export default function PocPage() {
  ...
  return (
    <div className="p-8">
      ...
      {updateError && <div className="mb-4 p-4 bg-red-100 text-red-700 rounded">{updateError}</div>}
          ...
          <tbody className="divide-y divide-gray-200">
            {pocs.map((poc) => (
              <tr key={poc._id} className="hover:bg-gray-50">
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{poc.pocNumber}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{poc.pocName}</td>
