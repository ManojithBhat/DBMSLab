  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-8">
        <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">Raise a Complaint</h2>
        <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
          If you have any issues or concerns, please submit them here. We take all complaints seriously and will reach
          out to you via email as soon as possible to address your concerns.
        </p>
        ...
        {submitStatus === "success" && (
          <p className="mt-4 text-center text-green-600">
            Your complaint has been successfully submitted. We will reach out to you soon.
          </p>
        )}
        {submitStatus === "error" && (
