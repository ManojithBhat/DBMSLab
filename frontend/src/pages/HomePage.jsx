...
const teamMembers = [
  {
    name: 'Manish Raj ',
    admissionNumber: '1RV22IS033',
    department: 'Information Science and Engineering',
  },
  {
    name: 'Manojith Bhat V',
    admissionNumber: '1RV22IS034',
    department: 'Information Science and Engineering',
  },
  {
    name: 'Pranav Motamarri',
    admissionNumber: '1RV22IS046',
    department: 'Information Science and Engineering',
  },
];
      ...
      <section className="py-20 md:py-32">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-10">
            Track, manage, and optimize your NSS activities with our powerful
            platform. Seamlessly organize events, monitor participation, and
            measure impact.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Everything you need to know about NSS
            </p>
          </div>
