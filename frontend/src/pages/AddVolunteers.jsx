    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-12">
          ...
          {addVolunteerError && (
            <p className="mt-4 text-sm text-red-500">{addVolunteerError}</p>
          )}
        </div>
        ...
        <div>
          ...
          {deleteVolunteerError && (
            <p className="mb-4 text-sm text-red-500">{deleteVolunteerError}</p>
          )}
                  ...
                  {event.participants.map((participant) => (
                    <tr key={participant._id}>
                      ...
                      <td className="px-6 py-4">
                        <button
                          className="text-sm font-medium px-4 py-2 rounded-md bg-red-500 text-white"
                          onClick={() =>
                            setShowDeleteConfirmation(participant.usn)
                          }
                        >
                          Delete
                        </button>
